        ...
        {instalado ? (
          ...
          <>
            <button
              ...
              className="w-full bg-blue-700 hover:bg-blue-800 text-white font-semibold py-3 rounded-xl transition text-sm mb-4"
            >
              📲 Instalar agora
            </button>

            {mostrarManual && (
              <div className="bg-gray-50 rounded-xl p-5 text-left space-y-3 mt-4">
                ...
                <div className="flex items-start gap-3">
                  <span className="text-xl">1️⃣</span>
                  <p className="text-sm text-gray-600">
                    No Chrome, clique no ícone <strong>⊞</strong> ou menu{" "}
                    <strong>⋮</strong> no canto superior direito
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-xl">2️⃣</span>
                  <p className="text-sm text-gray-600">
                    Clique em <strong>"Instalar IOA IOP"</strong> ou{" "}
